...
STEM_TYPE = "cherry_cross"; // [cherry_cross, fused_cross]
...
SHEATH_MAGNET_DIAMETER_TOLERANCE = 0;
...
for (item=RENDER) {
    if (item=="body") {
        switch_body(
            ...
            top_magnet_diameter=BODY_MAGNET_DIAMETER + SHEATH_MAGNET_DIAMETER_TOLERANCE,
        ...
        translate([-BODY_LENGTH/1.25,-TOTAL_TRAVEL/1.15,0]) // STEM
            rotate([0,0,0]) // Line it up so we can bring it closer
                stem_cherry_cross(TOTAL_TRAVEL, STEM_DIAMETER, SHEATH_LENGTH, WALL_THICKNESS, COVER_THICKNESS, STEM_TYPE,
                    magnet_wall_thickness=MAGNET_WALL_THICKNESS,
                    magnet_height=STEM_MAGNET_HEIGHT,
                    magnet_diameter=STEM_MAGNET_DIAMETER,
                    magnet_thickness_tolerance=MAGNET_THICKNESS_TOLERANCE,
        ...
        rotate([0,0,-90]) translate([
            ...
            rotate([90,0,45]) color([0,1,0,1]) // Keyup (green)
                stem_cherry_cross(TOTAL_TRAVEL, STEM_DIAMETER, SHEATH_LENGTH,
                    WALL_THICKNESS, COVER_THICKNESS, STEM_TYPE,
                    magnet_wall_thickness=MAGNET_WALL_THICKNESS,
                    magnet_height=STEM_MAGNET_HEIGHT,
                    magnet_diameter=STEM_MAGNET_DIAMETER,
                    magnet_thickness_tolerance=MAGNET_THICKNESS_TOLERANCE,
